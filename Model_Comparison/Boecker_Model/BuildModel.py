...
Species_Data = pd.read_excel('ModelData/Boecker_KineticModel_Version2.xlsx', sheet_name='Species')
Reactions_Data = pd.read_excel('ModelData/Boecker_KineticModel_Version2.xlsx', sheet_name='Reactions')
Functions_Data = pd.read_excel('ModelData/Boecker_KineticModel_Version2.xlsx', sheet_name='Functions')
Parameters_Data = pd.read_excel('ModelData/Boecker_KineticModel_Version2.xlsx', sheet_name='Parameters')
Rules_Data = pd.read_excel('ModelData/Boecker_KineticModel_Version2.xlsx', sheet_name='Rules')
...
with open('../../FurusawaModel_DistributedParameter/Boecker_Model/ModelData/v_params.txt','w') as fp:
    fp.write(','.join([str(v_val['value']) for v_name,v_val in Parameters.items() if v_name.startswith('V_max') or v_name.startswith('Vmax')]))  
